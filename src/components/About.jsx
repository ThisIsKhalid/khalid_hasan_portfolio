        ...
        <div className="flex flex-col md:flex-row justify-between gap-10">
          <div className="md:w-1/2">
            ...
            <p className="text-lightestSlate text-lg">
              ...
              with ReactJS, NodeJS, and MongoDB for the past six months and I
              have some of the best projects with them. I am very good at HTML,
              CSS, Bootstrap, Tailwind CSS, JavaScript, ReactJS. I am also
              comfortable with NodeJS and MongoDB. I am always energetic and
