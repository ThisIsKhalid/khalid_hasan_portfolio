    ...
    return (
      <section id='home' className="container mx-auto lg:px-0 px-5 my-24">
        <div>
          ...
          <p className='text-lg text-lightSlate my-4 lg:w-3/4'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laudantium quisquam deserunt maiores ex, quo quae commodi, minus vel praesentium libero nulla nemo magni unde adipisci.</p>
